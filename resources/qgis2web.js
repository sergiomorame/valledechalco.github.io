...
map.getView().fit([-11026109.575530, 2181104.888552, -11002606.365140, 2195373.209196], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Valle de Chalco</h2>';
        return titleElement;
    })(),
